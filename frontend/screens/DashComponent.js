...
class DashComponent extends React.Component {
  ...
  get = async () => {
    // g_antibiotics
    fetch("https://epics-project.herokuapp.com/gstats/countof/aid", {
      method: "GET",
      headers: new Headers({
    ...
    // u_antibiotics
    fetch("https://epics-project.herokuapp.com/stats/countof/aid", {
      method: "GET",
      headers: new Headers({
        token: await AsyncStorage.getItem("otp"),
      }),
    ...
    // g_pathogens
    fetch("https://epics-project.herokuapp.com/gstats/countof/pathid", {
      method: "GET",
      headers: new Headers({
        token: await AsyncStorage.getItem("otp"),
      }),
    ...
    // g_problems
    fetch("https://epics-project.herokuapp.com/gstats/countof/pid", {
      method: "GET",
      headers: new Headers({
        token: await AsyncStorage.getItem("otp"),
      }),
    ...
    // g_syndromes
    fetch("https://epics-project.herokuapp.com/gstats/countof/sid", {
      method: "GET",
      headers: new Headers({
        token: await AsyncStorage.getItem("otp"),
      }),
    ...
    // u_pathogens
    fetch("https://epics-project.herokuapp.com/stats/countof/pathid", {
      method: "GET",
      headers: new Headers({
        token: await AsyncStorage.getItem("otp"),
      }),
    ...
    // u_problems
    fetch("https://epics-project.herokuapp.com/stats/countof/pid", {
      method: "GET",
      headers: new Headers({
        token: await AsyncStorage.getItem("otp"),
      }),
    ...
    // u_syndromes
    fetch("https://epics-project.herokuapp.com/stats/countof/sid", {
      method: "GET",
      headers: new Headers({
        token: await AsyncStorage.getItem("otp"),
      }),
    ...
    // u_antibiotics
    fetch("https://epics-project.herokuapp.com/stats/mostcommon/aid", {
      method: "GET",
      headers: new Headers({
        token: await AsyncStorage.getItem("otp"),
      }),
